    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          />
          <DialogFooter>
            <Button onClick={handleImageUrlSubmit}>Inserir</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent className="p-2.5 flex items-center gap-x-2">
        ...
        />
        <Button onClick={() => onChange(value)}>Aplicar</Button>
      </DropdownMenuContent>
    </DropdownMenu>
  );
};
...
const HeadingLevelButton = () => {
  ...
  const headings = [
    { label: "Texto normal", value: 0, fontSize: "12px" },
